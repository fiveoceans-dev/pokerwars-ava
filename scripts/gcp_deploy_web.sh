...
SUBS="_IMAGE_URI=$(sanitize "$IMAGE_URI"),_BUILD_TARGET=web,_NEXT_PUBLIC_APP_URL=$SAN_APP_URL,_NEXT_PUBLIC_WS_URL=$SAN_WS_URL,_NEXT_PUBLIC_API_URL=$SAN_API_URL,_NEXT_PUBLIC_WALLETCONNECT_PROJECT_ID=$SAN_WC_PUBLIC,_WALLETCONNECT_PROJECT_ID=$SAN_WC"
